   ...
   class Frame2 extends JFrame
   {
         ...
         public Frame2()
         {
             ...
             add(rb2);
              ...
              l6 = new JLabel("ENTER CONTACT NUMBER");
              l6.setBounds(80 , 270 , 150 , 30);
              add(l6); 

              t5 = new JTextField();
              t5.setBounds(230 , 270 , 200 , 30);
              add(t5); 
       ...
       b2.addActionListener(new ActionListener()
       {
			...
			JOptionPane.showMessageDialog(Frame2.this,"Please Enter ADDRESS","ALERT",JOptionPane.PLAIN_MESSAGE);
 		     ...
 		     {
			JOptionPane.showMessageDialog(Frame2.this,"Please Enter CONTACT NUMBER","ALERT",JOptionPane.PLAIN_MESSAGE);
		     }
                     else
                     {   
            	 	...
            	 	String s3 = "BRANCH : "+t3.getText().trim();
                        String s4 = "CONTACT NUMBER : "+t5.getText().trim();

           
                          Frame2.this.setVisible(false);
                          new Frame3(s1 , s2 , s3, s4);                      
                     }
             }
       });  
                setVisible(true);
